...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public WeatherDbHelper(Context context) {
        ...
        Log.v(LOG_TAG, "DB path : " + dbPath);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        Log.v(LOG_TAG, "onCreate : table creation");
        final String SQL_CREATE_LOCATION_TABLE =
                "CREATE TABLE " + LocationEntry.TABLE_NAME + " (" +
                        LocationEntry._ID + " INTEGER PRIMARY KEY, " +
                        LocationEntry.LOCATION_SETTING + " TEXT UNIQUE NOT NULL, " +
        ...
        Log.v(LOG_TAG, "Table Created : " + SQL_CREATE_LOCATION_TABLE);
        sqLiteDatabase.execSQL(SQL_CREATE_WEATHER_TABLE);
        Log.v(LOG_TAG, "Table Created : " + SQL_CREATE_WEATHER_TABLE);
    }
